...
public class ProxyVersion_0 implements Serializable {
    ...
    public static Object newProxyInstance() throws Exception {
        ...
        String fileName = fileDir + "\\src\\main\\application\\net\\proxy\\StaticProxy.java";
        ...
        URL[] urls = new URL[]{(new URL("file:\\" + System.getProperty("user.dir") + "\\main"))};
        URLClassLoader ul = new URLClassLoader(urls);
        Class<?> c = ul.loadClass("application.net.proxy.StaticProxy");
        ...
        File classFile = new File(fileDir + "\\src\\main\\application\\net\\proxy\\StaticProxy.class");
//        javaFile.delete();
        classFile.delete();
